...
const Inventory = () => {
    ...
    const handlerestock = async (e) => {
        e.preventDefault();
        const inputValue = e.target.restock.value;
        ...
        if (data.modifiedCount) {
            toast.success('You have successfully restocked')
            setProduct(newProduct)
    ...
    return (
        <div>
            ...
            <div className="w-11/12 mx-auto flex justify-between">
                <h2 className="md:text-left capitalize my-5  text-xl font-semibold ">Restock?</h2>
                <div className="">
                    <form className="grid grid-cols-2" onSubmit={handlerestock}>
                        <input required className="mt-1 focus:ring-indigo-500 focus:border-indigo-500   shadow-sm sm:text-sm border-gray-300 rounded-md" type="number" name="restock" /> <button className="btn ml-5 text-xs md:text-base btn-info">Restock</button>
                    </form>
                </div>
            </div>
